...
def test_run_svd_example():
    """
    Test that the svd_example.py script runs successfully and produces output.
    """
    script_path_rel = "examples/matrix_factorization/svd_example.py"
    ...
    generic_keywords_present = (
        ...
        "예상 평점" in process.stdout or
            "Predicted Rating".lower() in process.stdout.lower() # Modified
    )
