...
def test_run_tfidf_example():
    """
    Test that the tfidf_example.py script runs successfully and produces output.
    """
    script_path_rel = "examples/content_based/tfidf_example.py"
    ...
    data_files_to_clean = [
        ...
        os.path.join(project_root, 'data/dummy_item_metadata.csv'), # tfidf_example might use this
